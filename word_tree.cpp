/* 
    ...
    Trees are slightly faster than binary search.
    Binary search:
     * string.compare_string for everything
     * will most likely take 15 or 16 calls of string.compare_string
    Tree:
     * Less characters being compared
     * O-time is more closely related to the length of the string
*/
